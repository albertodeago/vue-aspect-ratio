...
(function (global, factory) {
  ...
  (global = global || self, global.VueAspectRatio = factory());
    ...
    created: function created() {
      ...
      var _this$ar$split$map = this.ar.split(":").map(function (v) {
        return parseInt(v);
          ...
          _this$ar$split$map2 = _slicedToArray(_this$ar$split$map, 2),
          w = _this$ar$split$map2[0],
          h = _this$ar$split$map2[1];
  ...
  var __vue_staticRenderFns__ = [];
    ...
    var AspectRatio = normalizeComponent_1(
  ...
  var AspectRatio$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    'default': AspectRatio
  });
  ...
  var require$$0 = getCjsExportFromNamespace(AspectRatio$1);
